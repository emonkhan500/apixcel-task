    ...
    <div className=" ">
      ...
      <div className="relative flex flex-col lg:flex-row gap-4 md:gap-10 max-w-7xl mx-auto">
        ...
        <div className="w-1/2 lg:max-w-62 text-start ">
            <h1 className="text-xl xl:text-3xl font-semibold mb-7 text-[#191919]">What are Meme Coins?</h1>
  ...
  <div className="h-[600px] md:h-auto md:rotate-[2.603deg]  relative bg-[#B341FF] flex md:max-w-3xl mx-auto p-5 xl:p-10 rounded-2xl">
    <div className="flex-1 w-full   md:max-w-89 text-start">
      ...
      <p className="text-sm font-light text-white">
        ...
        online. People love to jump on trends, and these coins ride the wave of
        internet culture. Coins like Shiba Inu and Pepe Coin became hits because
        they got everyone talking (and tweeting!). But remember, they’re mostly
        for fun—they don’t usually have fancy tech or big projects behind them.
      </p>
    </div>
    ...
    />
      ...
      <div className=" relative bg-[#0FCDC8] flex max-w-2xl mx-auto p-10 rounded-2xl mt-8">
        ...
        <div className="max-w-90 text-end ">
            <h1 className="text-3xl font-semibold mb-7 text-[#191919]">Should you <br /> try them out?</h1>
            <p className="text-sm font-light text-[#191919]">If you’re curious and want to join the fun, meme coins can be exciting! But here’s the deal: they can be a bit of a rollercoaster—prices can shoot up or drop fast. If you’re just starting, only invest what you can afford to lose and enjoy the ride. Think of it like a fun experiment, not a serious plan to get rich!</p>
        </div>
        <div className="absolute -bottom-5 md:bottom-5 md:-left-10 lg:-left-30 text-base md:text-lg text-[#191919] px-3 lg:px-6 py-2 xl:py-3 rounded-xl bg-[#FFDD03]">Let me know if you’d like more tweaks!</div>
        <img className="absolute -left-30 md:-left-40 lg:-left-50 -top-40 md:-bottom-15 lg:-bottom-6" src="hand.png" alt="" />
      </div>
    </div>
  );
};
