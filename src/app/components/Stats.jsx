...
const Stats = () => {
    return (
        <section className="h-[700px]  lg:h-auto relative max-w-7xl mx-auto bg-[linear-gradient(180deg,#FFDD03_0%,#FBC403_100%)] rounded-3xl px-5 md:px-12 py-8 lg:py-18 my-20">
      ...
      <img className='absolute bottom-0 md:left-36 lg:left-47 xl:left-77 w-[400px] md:w-auto h-[340px] md:[300px]'  src="/cat.png" alt="" />
      <img className='h-44 xl:h-48 w-44 xl:w-48 absolute bottom-5 lg:-bottom-15 -left-20 lg:left-34 xl:left-47' src="/84.png" alt="" />
      <img className='absolute md:top-85 lg:-top-10 xl:-top-12 h-28 xl:h-32 w-28 xl:w-28 -right-10 lg:right-40 xl:right-75 rotate-x-12' src="/83.png" alt="" />
    </section>
    );
};
